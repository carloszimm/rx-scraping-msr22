...
const mainUrl = "https://pub.dev/packages/rxdart";

const ids = [
  "#list-of-classes--static-factories", //List of Classes / Static Factories
  "#list-of-extension-methods", //List of Extension Methods
];

const getList = page => page.next().find("li a");
